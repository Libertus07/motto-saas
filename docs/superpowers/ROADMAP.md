...
**Son doğrulama:** 2026-08-17<br>
**Doğrulanan temel:** `0fbb7b86221875742c8bfec5a4bede0df1dafde2`<br>
**Aktif öncelik:** `SEC-02` — Kalan `SECURITY DEFINER` bulgularının sınıflandırılması
...
| `SEC-02`     | **Kalan `SECURITY DEFINER` bulguları**<br>Sonuç: every remaining advisor finding will receive an evidence-backed classification.                  | Devam ediyor | Sonraki: complete the focused review plan and classify each refreshed production finding before any fix.<br>Detay: [Özel finansal belge rollout](../security/private-financial-document-rollout.md)<br>Kanıt: production Security Advisor refreshed read-only on 2026-08-17; function owner, ACL, caller, tenant checks, and tests remain to be classified. |
