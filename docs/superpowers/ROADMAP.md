...
| `ROADMAP-01` | **Merkezi yol haritası ve yönetim**<br>Sonuç: central roadmap, offline validation, contributor rules, and CI wiring are implemented locally.      | Yerelde tamam | Sonraki: independent review, push, pull request, GitHub CI, and merge.<br>Detay: [Yol haritası yönetim tasarımı](specs/2026-08-16-project-roadmap-governance-design.md)<br>Kanıt: Task 1 `e25c312`, `81692ef`, `da77860`, and `ae1d1c4`; Task 2 `ef889e8` and `15e2bab`; passing `npm run check`. |
