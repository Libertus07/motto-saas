      ...
      {isDelayed && !isCountDay && (
        <div className="bg-rose-500/10 border border-rose-500/30 backdrop-blur-md rounded-2xl p-4 sm:p-5 flex items-center gap-3 shadow-xl">
          ...
          <div>
            ...
            <p className="text-stone-300 text-xs mt-0.5">
              Son sayımınızın üzerinden <strong className="text-rose-300 underline">{daysSinceLastCount} gün</strong>{' '}
              geçmiş. Teorik stoklarınız gerçeği yansıtmıyor olabilir, acilen sayım yapmanız önerilir.
            </p>
          </div>
        </div>
      )}
