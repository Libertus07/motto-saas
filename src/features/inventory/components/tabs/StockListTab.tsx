                    ...
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="divide-y divide-stone-800/50 text-xs sm:text-sm">
                            {filteredMaterials.map(mat => {
                                const isCritical =
                                    (mat.stock_quantity || 0) <= (mat.critical_stock_level || 0) &&
                                    (mat.critical_stock_level || 0) > 0
                                                        ...
                                                        <div className="grid grid-cols-1 sm:grid-cols-4 gap-3">
                                                            <div>
                                                                ...
                                                                <input
                                                                    ...
                                                                    onChange={e =>
                                                                        onInlineFormChange({ ...inlineForm, quantity: e.target.value })
                                                                    }
                                                            ...
                                                            <div>
                                                                ...
                                                                <input
                                                                    ...
                                                                    onChange={e =>
                                                                        onInlineFormChange({ ...inlineForm, unit_price: e.target.value })
                                                                    }
                                                            ...
                                                            <div className="sm:col-span-2">
                                                                ...
                                                                <div className="flex gap-2">
                                                                    <input
                                                                        ...
                                                                        onChange={e =>
                                                                            onInlineFormChange({ ...inlineForm, note: e.target.value })
                                                                        }
