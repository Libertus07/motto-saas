      ...
      <div className="bg-stone-900 border border-stone-800 rounded-2xl w-full max-w-2xl max-h-[85vh] flex flex-col">
          ...
          <div>
            ...
            {suggestions.length === 0 ? (
              ...
              <p className="text-stone-400 text-sm">
                Yapay zeka <span className="text-amber-400 font-bold">{suggestions.length} hammadde</span> için kategori
                önerisi üreetti. Onayla veya reddederek uygulayın.
              </p>
            )}
          </div>
          <button onClick={onClose} className="text-stone-500 hover:text-white text-xl mt-0.5 ml-4">
            ✕
          </button>
        </div>
        ...
        {suggestions.length > 0 && (
          <div className="px-6 py-4 border-t border-stone-800 flex items-center justify-between gap-3">
            <p className="text-stone-500 text-xs">İstemediğin öneriyi listeden ✕ ile çıkarabilirsin.</p>
