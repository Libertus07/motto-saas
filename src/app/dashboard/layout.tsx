...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  useAppTour(
    ...
    [
      ...
      },
      {
        ...
        popover: {
          title: 'Modül Menüsü 🧭',
          description:
            'Uygulamanın tüm güçlerine buradan erişebilirsiniz. Hammaddeler, Üretim Reçeteleri ve Fiyat Motoru birbiriyle entegre çalışır.',
          side: 'right',
          align: 'start',
        },
      },
    ...
    1000,
  ) // Sayfa yüklenmesinden 1 sn sonra başlasın
