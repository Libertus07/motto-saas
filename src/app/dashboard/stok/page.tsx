  ...
  useAppTour('stok', [
    {
      ...
      popover: {
        ...
        description: 'Giriş, çıkış veya fireyi anında kaydederek stok seviyelerini güncel tutun.',
      },
    },
    {
      element: '#tour-stock-tabs',
      popover: {
        title: 'Doğru çalışma alanını seçin',
        description: 'Stok durumu, hareketler, sayım ve fire analizi arasında buradan geçin.',
      },
    },
    {
                ...
                {tab.badge != null && (
                  <span
                    className={`px-2 py-0.5 rounded-full text-[10px] font-extrabold ${
                      isActive ? 'bg-stone-950/20 text-stone-950' : tab.badgeColor || 'bg-stone-800 text-stone-300'
                    }`}
                  >
                    {tab.badge}
                  </span>
