...
export default function Raporlar() {
  ...
  const fetchStats = useCallback(async () => {
    ...
    if (settings) {
      ...
      if (expenseCatSetting)
        setCategoryLabels(typeof expenseCatSetting === 'string' ? JSON.parse(expenseCatSetting) : expenseCatSetting)
    }
  ...
  // Hesaplamalar
  const monthlyExpenses = expenses.reduce((t, e) => t + (e.period === 'yearly' ? e.amount / 12 : e.amount), 0)
  ...
  const productSalesStats = sales.reduce(
    (acc, sale) => {
  ...
  const avgMargin =
    productsWithMargin.length > 0 ? productsWithMargin.reduce((t, p) => t + p.margin, 0) / productsWithMargin.length : 0
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-stone-400 text-sm">
                    Yapay zeka ile tedarikçi fişlerinden fiyat ve stokları otomatik güncelle.
                  </p>
                </div>
              </div>
              <div
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-stone-400 text-sm">
                    Z raporunun fotoğrafını çek, gün sonu satışlarını ve stok düşümlerini otomatik yap.
                  </p>
                </div>
              </div>
              <div
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-stone-400 text-sm">
                    Altın, döviz veya varlık fişlerinizi okutarak portföyünüze ekleyin.
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="bg-stone-900 border border-stone-800 rounded-xl p-4">
                ...
                <p className="text-2xl font-bold text-amber-400">{formatCurrency(monthlyExpenses)}</p>
              </div>
              <div className="bg-stone-900 border border-stone-800 rounded-xl p-4">
                  ...
                  {Object.entries(expenseCategories)
                    ...
                    .map(([cat, amount]) => (
                      <div key={cat} className="flex items-center gap-3">
                        ...
                        <span className="text-red-400 text-sm w-24 text-right">{formatCurrency(amount)}</span>
        ...
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
          <div className="bg-stone-900 border border-amber-500/30 rounded-xl p-6 w-full max-w-2xl max-h-[90vh] flex flex-col">
            <div className="flex justify-between items-center mb-6">
              ...
              <button onClick={() => setAiModalOpen(false)} className="text-stone-500 hover:text-white text-xl">
                ✕
              </button>
            </div>
                      ...
                      {aiReport.recommendations?.map((rec, i) => (
                        <div key={i} className="bg-stone-800 rounded-lg p-4 border border-stone-700">
                          <div className="flex items-start justify-between mb-2">
                            ...
                            <span className="bg-stone-900 text-xs text-stone-400 px-2 py-1 rounded">
                              Öneri #{i + 1}
                            </span>
                          </div>
                          ...
                          <div className="space-y-3 mt-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-stone-300 bg-green-900/10 p-2 rounded border border-green-900/30">
                                {rec.action}
                              </p>
                            </div>
                            <div>
