          ...
          <div className="space-y-6">
            <div className="bg-stone-900 border border-stone-800 rounded-xl p-8 text-center border-dashed">
              ...
              <p className="text-stone-400 mb-6 max-w-md mx-auto">
                Altın alım fişi, Döviz bürosu makbuzu veya Gayrimenkul dekontunu yükleyin. Yapay zeka yatırım
                bilgilerini okuyup portföyünüze otomatik ekler.
              </p>
