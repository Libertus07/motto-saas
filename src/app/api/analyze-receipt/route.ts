...
ÖNEMLİ KURAL 6 (BEDELSİZ, PROMOSYON VE İADE ÜRÜNLER): Fiyatı veya tutarı 0.00 olan (bedelsiz/promosyon) veya eksi (-) değerli olan (iade) kalemleri atlama. Bunları da mutlaka ürün listesine dahil et. EĞER BİR SATIRDA "İADE" (return) YAZIYORSA veya tutar eksi/çizgi (— 100 —) ile belirtilmişse, o ürünün MİKTARINI VE TOPLAM TUTARINI mutlaka eksi (-) işaretli olarak yaz (örn: quantity: -5, totalPrice: -100). Fiyatı 0 ise 0 olarak bırak.
