...
ÖNEMLİ KURAL 8 (GERÇEK / GÜNCEL GENEL TOPLAM): Faturada iade/iptal edilen ürünler varsa, bu ürünlerin tutarları ana faturadan (matbu tutardan) DÜŞÜLMELİDİR. Eğer faturanın üzerine tükenmez kalemle el yazısıyla güncel/net bir toplam (örn: "Güncel 13.128", "- 4.010" vb.) yazılmışsa, "total_amount" alanına KESİNLİKLE bu elle yazılmış son güncel rakamı yaz. Eğer elle yazılmamışsa, iade edilen kalemleri basılı toplam tutardan matematiksel olarak çıkarıp net toplamı "total_amount" alanına yaz. "total_amount" her zaman aldığın ürünlerin gerçek toplamı olmalıdır.
