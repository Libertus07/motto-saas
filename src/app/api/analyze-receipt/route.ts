...
ÖNEMLİ KURAL 5 (FİYAT VE MATEMATİK - YUVARLAMA YASAK): Çıkardığın her bir ürün için totalPrice (Toplam Tutar) değerini FATURADA YAZANLA BİREBİR AYNI YAZ. Asla kendi hesapladığın sonucu yuvarlayarak yazma. unitPrice (Birim Fiyat) hesaplarken veya okurken ASLA YUVARLAMA YAPMA (Örn: 0.165 ise 0.165 olarak bırak, 0.17 yapma). quantity * unitPrice = totalPrice matematiği kuruşu kuruşuna tutmalıdır.
