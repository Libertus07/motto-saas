    ...
    >
      ...
      >
        ...
        {isPdf ? (
          ...
          >
            <iframe src={url} className="w-full h-full rounded-2xl border-0 bg-white" title="PDF Önizleme" />
          </div>
        ) : isImage ? (
          ...
          <div className="p-8 text-center bg-stone-900/90 border border-stone-800 rounded-3xl max-w-md shadow-2xl backdrop-blur-md my-auto">
            ...
            <p className="text-stone-400 text-sm mb-6 leading-relaxed">
              Bu dosya türü ekranda doğrudan işlenemiyor. Dosyayı görüntülemek veya kaydetmek için lütfen aşağıdaki
