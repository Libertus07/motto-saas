          ...
          >
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3
                    className={`font-bold text-lg transition-colors ${isExpanded ? 'text-amber-400' : 'text-stone-200'}`}
                  >
                    {group.title}
                  </h3>
                  {group.subtitle && <p className="text-sm text-stone-500 mt-0.5">{group.subtitle}</p>}
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div
                  className={`w-8 h-8 flex items-center justify-center rounded-full bg-stone-800/80 border border-stone-700 text-stone-400 transition-all duration-300 ${isExpanded ? 'rotate-180 bg-amber-500/10 border-amber-500/20 text-amber-500' : ''}`}
                >
                  ▼
                </div>
              </div>
            ...
            >
              <div className="overflow-hidden">
                <div className="border-t border-stone-800/50 bg-stone-950/30">{renderContent(group.items, group)}</div>
              </div>
            </div>
          </div>
        )
